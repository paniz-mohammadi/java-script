...
const editModepp = document.querySelector(".iconga");
const rr = document.querySelector(".lol");
...
function showTask()
{
    ...
    todoArray.forEach((element, index)=>{
        newTag += `<li>${element.title}<span class="icon"><i class="fa-solid fa-trash-can" onclick="removeTask(${index})"></i><i class="fa fa-edit"></i></span></li>`;
    });
...
editModepp.addEventListener(()=>{
     console.log("kk")
    var editInput = document.createElement("input");
    
    rr.toggleAttribute(editModepp)
})
